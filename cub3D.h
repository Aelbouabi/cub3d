...
/*   Updated: 2024/11/19 16:28:32 by aelbouab         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	char_check_bonus(char *line);
void	player_nb_bonus(char *line);
void	skep_nl_bonus(char *line);
void	freeall_bonus(char **ptr);
void	empty_sp_bonus(char **map, t_cub *cub);
void	ft_draw_bonus(t_all *all);
void	ft_error_bonus(char *s, t_cub *cub, int index);
void	check_number_bonus(t_cub *cub, int j, int i, int l);
int		check_f_c_bonus(t_cub *cub, int i, int j, int k);
void	check_valid_con_bonus(t_cub *cub, int j, int i);
void	check_valid_file_bonus(t_cub *cub, int i, int j);
int		find_i_bonus(t_cub *cub);
void	parsing_bonus(char *s, t_cub *cub);
int		ft_color_bonus(unsigned char r,
			unsigned char g, unsigned char b, unsigned char a);
void	draw_map_bonus(t_all *all, int color, int type);
...
void	draw_mp_bonus(t_all *all, char c);
void	ft_draw_map_bonus(t_all *all);
void	ft_draw_map_bonus(t_all *all);
void	player_angle_bonus(t_all *all);
int		beetwen_bonus(t_all *all, float yend, float xend);
void	hor_point_bonus(t_all *all, float angle);
int		point_ch_bonus(t_all *all, float san, float can);
void	ver_point_bonus(t_all *all, float angle);
float	dest_vita1_bonus(t_all *all);
float	dest_vita2_bonus(t_all *all);
void	draw_rm_bonus(t_all *all, float wall_h);
...
void	fill_fc_bonus(char *s, t_cub *cub, int index);
void	key_rotation_bonus(t_all *all);
void	check_door_bonus(t_all *all);
void	draw_minimap_bonus(t_all *all);
void	close_door_bonus(t_all *all);
void	draw_line_bonus(t_all *all);
void	slide_in_bonus(t_all *all, float y, float x);
