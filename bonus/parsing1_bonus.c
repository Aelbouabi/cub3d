...
/*   Updated: 2024/11/16 16:20:09 by aelbouab         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (!point_ch_bonus(all, y, 0))
	{
		all->player->y_mini += y / 50;
		all->player->y += y;
	}
	if (!point_ch_bonus(all, 0, x))
	{
